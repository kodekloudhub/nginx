...
function my_test {
  ...
  httpx -m GET http://e7240/api/items| tee $TEMP_1
...
my_test "httpx -m POST -d key key_7006 -d value value_7006 http://e7240/api/items" "key_7006" "--" "Posting 7006"
my_test "httpx -m POST -d key key_7007 -d value value_7007 http://e7240/api/items" "key_7007" "--" "Posting 7007"
my_test "httpx -m GET http://e7240/api/items" "key_7007" "--" "Is key 7007 present?"
my_test "httpx -m GET http://e7240/api/items" "value_7007" "--" "Is 7007's value value_7007?"   # Automated testing found this bug!

my_test "httpx -m GET http://e7240/api/items" "key_7006" "--" "Is key 7006 present before deleting it?"
my_test "httpx -m DELETE -p key key_7006 http://e7240/api/items/" "value_7006" "-v" "Deleting 7006"
my_test "httpx -m GET http://e7240/api/items" "key_7006" "-v" "Is 7006 gone now that it was deleted?"
...
# my_test "httpx -m DELETE -p key key_7006 http://e7240/api/items/" "value_7006" "-v" "Deleting 7006 again.  Testing idempotence"
# my_test "httpx -m GET http://e7240/api/items" "key_7006" "-v" "Is 7006 still gone?"
...
my_test "httpx -m GET http://e7240/api/items" "key_7009" "--" "Is key 7009 present after deleting 7008?"

my_test "httpx -m GET http://e7240/api/items" "key_7010" "-v" "Is key 7010 present BEFORE it was updated?"
my_test "httpx -m PUT -d key key_7010 -d value value_7010 http://e7240/api/items/" "value_7010" "--" "Updating 7010, which did not exist"
my_test "httpx -m GET http://e7240/api/items" "key_7010" "--" "Is key 7010 present after it was updated?"
